...
@RestController
@RequestMapping("/api/j-colibri-kafka")
public class JColibriKafkaResource {
    private final Logger log = LoggerFactory.getLogger(JColibriKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JColibriKafkaResource(KafkaProperties kafkaProperties) {
