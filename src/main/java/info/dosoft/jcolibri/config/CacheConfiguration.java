package info.dosoft.jcolibri.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("jColibri");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("jColibri");
        ...
        config.getMapConfigs().put("info.dosoft.jcolibri.domain.*", initializeDomainMapConfig(jHipsterProperties));
